$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Farewell Ortho UI 2018-2019",

      // Event start date
      start: new Date("June 5, 2024 12:00 UTC+7"),
      ...
      end: new Date("June 5, 2024 14:30 UTC+7"),

      // Event Address
      address:
        "Park Hyatt Jakarta, Jl. Kebon Sirih.17-19 Kb. Sirih Kec. Menteng Kota Jakarta Pusat Daerah Khusus Ibukota, Jakarta, Daerah Khusus Ibukota Jakarta 10340",

      // Event Description
      description: "Farewell Lunch Ortho UI 2018-2019",
    },
  });
...
// Google map
function initMap() {
  var location = { lat: -6.1848202, lng: 106.8279514 };
  ...
  var marker = new google.maps.Marker({
    position: { lat: -6.1848202, lng: 106.8279514 },
    map: map,
  });
